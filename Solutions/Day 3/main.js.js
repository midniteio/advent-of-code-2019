...
function checkPlot(point, steps, marker) {
  if (point !== "0, 0"){
    if (!plot[point]) {
      plot[point] = { [marker]: steps }; 
    } else if (!plot[point][marker]) {
      plot[point][marker] = steps; 
